...
#os.system('clear')
#dir = os.getcwd()
os.system('cd Kurento && python kurento_test.py') #run KMS
#os.system('cd Orion && python Orion.py') #run Orion
#os.system('cd AuthzForce && python authzforce.py') #run AuthzForce
#os.system('cd KeyRock && python keyrock.py') #run KeyRock
#os.system('cd Knowage && python knowage.py') #run Knowage
#os.system('clear')
