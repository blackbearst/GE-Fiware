...
os.system('cd ge_fiware/report && docker cp report.json gefiware_fiware_report_1:/ && docker exec gefiware_fiware_report_1 bash -c "mongoimport --db report_fiware --collection fiware --file report.json"')
...
print (rep)
report.close()
os.system('cd ge_fiware/report && rm report.json')
